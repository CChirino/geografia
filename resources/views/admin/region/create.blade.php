...
@section('content')
    <form method="POST" action="{{ route('regiones.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="container mx-auto">
            <div class="flex flex-wrap mx-auto -mx-3 mb-6">
                ...
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                  ...
                  <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('altitud') is-invalid @enderror" id="altitud"  name="altitud" type="number" value="{{ old('altitud') }}" required autocomplete="superficie" autofocus>
                  @error('altitud')
                  <div class="border border'red-400 rounded-b bg-red-100 mt-1 px-4 py-3 text-red-700">{{ $message }}</div>
                  @enderror
                </div>
            ...
            <div class="flex flex-wrap -mx-3 mb-2">
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                  ...
                  <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('poblacion_region') is-invalid @enderror" id="poblacion_region"  name="poblacion_region" type="number" value="{{ old('poblacion_region') }}" required autocomplete="poblacion_region" autofocus>
