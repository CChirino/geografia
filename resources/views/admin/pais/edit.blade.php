...
@section('content')
<form method="POST" action="{{ route('paises.update',$pais->id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="container mx-auto">
      <div class="flex flex-wrap mx-auto -mx-3 mb-6">
          ...
          <div class="w-full px-3">
              ...
              <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="nombre" name="nombre" type="text" value="{{$pais->nombre}}">
          </div>
          <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" >
              Capital
            </label>
            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white @error('capital') is-invalid @enderror" id="capital" name="capital" type="text" value="{{$pais->capital}}" required autocomplete="capital" autofocus >
            @error('capital') 
