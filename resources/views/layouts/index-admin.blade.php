...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="{{ asset('img/logo.png')}}" width="48" height="48 ">
  {{-- <link rel="stylesheet" type="text/css" href="css/style.css">   --}}
  <title>Geografia - @yield('titulo')</title>
...
<div class="md:fixed md:w-full md:top-0 md:z-20 flex flex-row flex-wrap items-center bg-white p-6 border-b border-gray-300">
    ...
    <div class="flex-none w-56 flex flex-row items-center">
      ...
      <strong class="capitalize ml-1 flex-1">Geografia</strong>
        ...
        <div class="dropdown relative md:static">
          ...
          <button class="menu-btn focus:outline-none focus:shadow-outline flex flex-wrap items-center">
            ...
            <div class="ml-2 capitalize flex ">
              <h1 class="text-sm text-gray-800 font-semibold m-0 p-0 leading-none">Sr. Jose</h1>
...
<div class="h-screen flex flex-row flex-wrap">
  ...
  <div id="sideBar" class="relative flex flex-col flex-wrap bg-white border-r border-gray-300 p-6 flex-none w-64 md:-ml-64 md:fixed md:top-0 md:z-30 md:h-screen md:shadow-xl animated faster">
    ...
    <div class="flex flex-col">
      ...
      <p class="uppercase text-xs text-gray-600 mb-4 tracking-wider">Paises</p>

      <!-- link -->
      <a href="{{ route('paises.index') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
      ...
      <!-- link -->
      <a href="{{ route('paises.create') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        <i class="far fa-flag text-xs mr-2"></i>
        Crear Paises
      </a>

      <a href="{{ route('galerias-paises.index') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        <i class="fas fa-images text-xs mr-2"></i>
        Listado de fotos Paises
      </a>
      <a href="{{ route('galerias-paises.create') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        <i class="fas fa-upload text-xs mr-2"></i>
        Subir de fotos Paises
      </a>
      <!-- end link -->

      <p class="uppercase text-xs text-gray-600 mb-4 tracking-wider">Regiones</p>

      <!-- link -->
      <a href="{{ route('regiones.index') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        <i class="fas fa-list text-xs mr-2"></i>                
        Listar Regiones
      </a>
      <!-- end link -->
      ...
      <!-- link -->
      <a href="{{ route('regiones.create') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        <i class="far fa-flag text-xs mr-2"></i>
        Crear Regiones
      </a>

      <a href="{{ route('galerias-regiones.index') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        <i class="fas fa-images text-xs mr-2"></i>
        Listado de fotos Regiones
      </a>
      <a href="{{ route('galerias-regiones.create') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        <i class="fas fa-upload text-xs mr-2"></i>
        Subir de fotos de Regiones
      </a>
